...
![Architecture diagram](/images/work-shop-1/diagram1.png)
...
<Steps>
  <Step>
    ...
    - **Repository:** [camdao/NeonFoodmap](http://github.com/camdao/NeonFoodmap)
    - Clone mã nguồn về máy bằng lệnh:
      ```bash
      git clone http://github.com/camdao/NeonFoodmap.git
      ```
  </Step>
  <Step>
    ### Tài khoản AWS
